...
<script>
	...
	$(function(){
		$("#btn").click(function() {
			...
			//innerHTML대신 html()을 사용한 것
			//javasrcipt에서 infotableDoc.innerHTML = infortableDoc.innerHTML + temp;
			//jQuery에서 infotableDoc.html(node + temp);
			var infotableDoc =$("#infoTable");
			var temp = "<tr><td>"+useridVal+"</td><td>"+usernameVal+"</td><td>"+usertypeVal+"</td></tr>";	
			infotableDoc.html(function(index, node){ 
				return node + temp; //node는 원래 갖고 있던 내용물에 temp라는 새로운 내용을 붙여 반환   
			});
